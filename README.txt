...
https://github.com/iFrogLab/ArBleSample


===========================================================================
DESCRIPTION:

iFrogLab ArBle is an Arduino and Bluetooth Low Energy (BLE) Shield for Raspberry Pi.
 It is designed to work with Arduino boards, Raspberry Pi or compatibles, including Arduino Uno, Mega 2560, Leonardo, Due, Raspberry Pi and Raspberry Pi 2,  It allows you to connect your Arduino/Raspberry Pi boards with other BLE Central device like a smartphone or tablet. So you can develop some applications like:
